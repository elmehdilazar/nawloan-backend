    ...
    <table class="table datatables datatables-active" id="">
        ...
        @foreach ($orders as $index=>$order )
            <tr>
                ...
                <td>
                    <div class="user-col">
                        <img src="{{ asset($order->user?->userData?->image ?: 'uploads/users/default.png') }}" alt="{{ $order->user?->name }}">
                                    ...
                                    <li class="offer-item">
                                        <div class="flex-align-center">
                                            <a href="" class="flex-col-center">
                                                <img src="{{ asset($offer->user?->userData?->image ?: 'uploads/users/default.png') }}" class="avatar">
