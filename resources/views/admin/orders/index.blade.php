            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-3">
                <div class="input-group mb-0">
                    ...
                    <div class="input-group">
                        <input type="text" class="fe-14" name="number" id="number"
                               value="{{request()->number}}" placeholder="@lang('site.number')">
            ...
            <div class="form-group col-xl-3 col-lg-4 col-md-6 col-12 mb-3">
                <div class="select-group mb-0">
                    ...
                    <select class="form-control select2" id="shipment_type_id" name="shipment_type_id">
                        ...
                        <option value="{{$shipment->id}}" {{ request()->shipment_type_id== $shipment->id ? 'selected' : '' }}>
            ...
            <div class="form-group col-xl-3 col-lg-4 col-md-6 col-12 mb-3">
                <div class="select-group mb-0">
                    ...
                    <select class="form-control select2 no-search" id="status" name="status">
                        <option value="0" selected>@lang('site.view_all')</option>
                        <option value="pend" {{ request()->status== 'pend' or request()->status== 'pending'  ? 'selected' : '' }}>
                            @lang('site.pend')
                        </option>
                ...
                <td>
                    <div class="user-col">
                        @if ($order->user && $order->user->userData && $order->user->userData->image != '')
                            <img src="{{ asset($order->user->userData->image) }}" alt="{{ $order->user->name }}">
                        @else
                            <img src="{{ asset('uploads/users/default.png') }}" alt="{{ $order->user->name }}">
                        @endif
                                    ...
                                    <li class="offer-item">
                                        <div class="flex-align-center">
                                            <a href="" class="flex-col-center">
                                                <img src="{{ $offer->user && $offer->user->userData && $offer->user->userData->image != '' 
    ? asset($offer->user->userData->image) 
    : asset('uploads/users/default.png') }}" class="avatar">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content yellow-background border-0">
                <div class="modal-header border-bottom-0 flex-space">
                    <h4 class="modal-title mb-0" id="verticalModalTitle_{{$index}}">@lang('site.order') {{' # '.$order->id}}</h4>
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close">
                        <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38">
                            <path id="Exclusion_23" data-name="Exclusion 23"
                                  d="M26.384,37.578h-14a12,12,0,0,1-12-12v-14a12,12,0,0,1,12-12h14a12,12,0,0,1,12,12v14a12,12,0,0,1-12,12Zm-7-16.4h0L26,27.793l2.6-2.6-6.617-6.617L28.6,11.961,26,9.363,19.384,15.98,12.767,9.363l-2.6,2.6,6.617,6.617-6.617,6.617,2.6,2.6,6.616-6.616Z"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-12 col-sm-6 col-12">
                                        <div class="participant">
                                            ...
                                            <div class="flex-align-center">
                                         <img src="{{ $order->serviceProvider && $order->serviceProvider->userData && $order->serviceProvider->userData->image != '' 
                    ...
                    <div class="row col-gap-70">
                        ...
                        <div class="col-lg-6 col-12">
                                ...
                                @if($order->offer)
                                    ...
                                    <span class="flex-align-center">
                                        ...
                                        @lang('site.sub_total')
                                            ...
                                            <span class="amount">{{$order->offer->sub_total  ?? 0.00}} {{' '.setting('currency_atr')}}</span>
                                        </div>
                                    </div>
                                @endif
                            @endif
                            <div class="driver-card">
                                <div class="flex-align-center">
                                    <img src="{{asset('assets/images/driver.png')}}" alt="">
                                    <div class="flex-column">
                                        <span class="name">Mohammad Abdallah</span>
                                        <span class="rate">
                                        <div class="flex-align-center">
                                            <img src="{{asset('assets/images/svgs/star-fill.svg')}}" alt="">
                                            <img src="{{asset('assets/images/svgs/star-fill.svg')}}" alt="">
