...
@php
    $customerImage = optional($user->userData)->image;
    $customerAvatar = $customerImage ? asset($customerImage) : asset('uploads/users/default.png');
@endphp
...
<div class="container-fluid">
    <div class="row page-titles mx-1">
        <div class="col px-1 mx-1 ">
            ...
            <img src="{{ $customerAvatar }}" style="width:100px;height:100px;border-radius: 50%;">
            ...
            <div class="card shadow" style="background-color:#fbfafa;border-radius: 20px;">
                <div class="card-body p-0 py-2">
                    <div class="d-flex justify-content-start">
                        <div class="w-20 px-1">
                            <img src="{{ $reviewerAvatar }}" style="width:100px;height:100px;border-radius: 50%;">
                        </div>
                        <div class="col w-80">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('admin.customers.evaluate.changeStatus',$eval->id) }}" class="btn btn-danger">
                                        <i class="fas fa-times"></i>
                                    </a>
                                    @else
                                    <a href="{{ route('admin.customers.evaluate.changeStatus',$eval->id) }}" class="btn btn-success">
