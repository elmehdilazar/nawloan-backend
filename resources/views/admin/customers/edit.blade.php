...
@section('title',' | ' . __('site.edit') .' '. __('site.the_customer'))
@section('styles')
    <!-- IntlTelInput -->
...
@endsection
@section('content')
<h2 class="section-title mb-5">Edit Customer</h2>
<div class="row">
        ...
        <form action="{{route('admin.customers.update',$user->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation"
                           placeholder="@lang('site.con_password')" value="{{old('password_confirmation')}}" >
                </div>
            ...
            <div class="checkbox-group">
                ...
                <ul class="checkbox-list">
                    ...
                    <li>
                        <div class="form-check">
                            <input class="form-check-input transparent" type="checkbox" id="revision"  name="revision" @if($user->userData->revision==1) checked @endif>
                    ...
                    <li>
                        <div class="form-check">
                            <input class="form-check-input transparent" type="checkbox"
                                   id="vip" name="vip" @if($user->userData->vip==1) checked @endif>
