...
@section('title',' | '. __('site.Edite Article Category'))
@section('styles')
    <!-- Quill Editor -->
...
@section('content')
    ...
    <form action="{{route('admin.article_categories.update', $category->id)}}" method="post">
        @csrf
        @method('put')
        <h2 class="section-title mb-5">@lang('site.Edite Article Category')</h2>
        <div class="row">
            <div class="col-xl-6 col-lg-12 co-12">
                ...
                <div class="input-group">
                    ...
                    <input value="{{$category->category_ar}}" type="text" name="category_ar" id="category_ar" placeholder="@lang('site.PLease Enter Name Of Category')">
                    @error("category_ar")
                ...
                <div class="input-group">
                    ...
                    <input value="{{$category->meta_title_ar}}" type="text" name="meta_title_ar" id="meta_title_ar" placeholder="@lang('site.Please Enter Meta title')">
                    @error("meta_title_ar")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="input-group">
                    ...
                    <input value="{{$category->slug_ar}}" type="text" name="slug_ar" id="slug_ar" placeholder="@lang('site.Please Enter Slug')">
                    @error("slug_ar")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
            ...
            <div class="col-xl-6 col-lg-12 co-12">
                ...
                <div class="input-group">
                    <label for="">@lang('site.Name Of Category')</label>
                    <input value="{{$category->category_en}}" type="text" name="category_en" id="category_en" placeholder="@lang('site.PLease Enter Name Of Category')">
                    @error("category_en")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="input-group">
                    <label for="">@lang('site.meta_title')</label>
                    <input value="{{$category->meta_title_en}}" type="text" name="meta_title_en" id="meta_title_en" placeholder="@lang('site.Please Enter Meta title')">
                    @error("meta_title_en")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="input-group">
                    <label for="">@lang('site.slug')</label>
                    <input value="{{$category->slug_en}}" type="text" name="slug_en" id="slug_en" placeholder="@lang('site.Please Enter Slug')">
                    @error("slug_en")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
