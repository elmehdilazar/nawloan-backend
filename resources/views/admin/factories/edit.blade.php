...
@section('title',' | ' . __('site.edit') .' '. __('site.factory'))
@section('styles')
    <!-- IntlTelInput -->
...
@section('content')
<h2 class="section-title mb-5">@lang('site.edit') @lang('site.factory')</h2>
@if(empty($user->userData->commercial_record) || empty($user->userData->tax_card))
    <div class="">
...
@endif
<form action="{{route('admin.factories.update',$user->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('put')
    <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="image-input">
                        <label for="">Enterprise Logo</label>
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" id="name" name="name"
                           placeholder="@lang('site.please_enter') @lang('site.company_name')"
                ...
                <div class="international-phone gray">
                    <div class="position-relative">
                        <input type="tel" id="intl_phone" class="form-control phone"
                               placeholder="@lang('site.please_enter') @lang('site.phone_n')"
                               value="{{$user->phone}}">
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="email" name="email" id="email"
                           placeholder="@lang('site.please_enter') @lang('site.email')" value="{{$user->email}}">
                </div>
                @error('email')
                <span class="text-danger">{{$message}}</span>
                @enderror
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" id="commercial_record" name="commercial_record"
                           ...
                           value="{{$user->userData->commercial_record}}" required>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="image-input wide">
                        ...
                        <div class="imageUpload-wrapper"
                             style="background-image: url({{asset('assets/images/no-image.jpg')}})">
                            <div id="imageUpload" style="background-image: url({{$user->userData->commercial_record_image_f !='' ? asset($user->userData->commercial_record_image_f) : asset('uploads/img/logo.png')}})">
                                <input type="file" name="commercial_record_image_f" id="commercial_record_image_f" class="mediaFile">
                                <label for="commercial_record_image_f"><i class="fad fa-pencil"></i></label>
                                <button id="clear-input"><i class="fal fa-times"></i></button>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-12">
                    <div class="image-input wide">
                        ...
                        <div class="imageUpload-wrapper"
                             style="background-image: url({{asset('assets/images/no-image.jpg')}})">
                            <div id="imageUpload" style="background-image: url({{$user->userData->commercial_record_image_b !='' ? asset($user->userData->commercial_record_image_b) :asset('uploads/img/logo.png')}})">
                                <input type="file" name="commercial_record_image_b" id="commercial_record_image_b" class="mediaFile">
                                <label for="commercial_record_image_b"><i class="fad fa-pencil"></i></label>
                                <button id="clear-input"><i class="fal fa-times"></i></button>
                            </div>
                        </div>
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" id="tax_card" name="tax_card"
                           ...
                           value="{{$user->userData->tax_card}}" required>
                </div>
                @error('tax_card')
                <span class="text-danger">{{$message}}</span>
                @enderror
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="image-input wide">
                        ...
                        <div class="imageUpload-wrapper"
                             style="background-image: url({{asset('assets/images/no-image.jpg')}})">
                            <div id="imageUpload" style="background-image: url({{$user->userData->tax_card_image_f !='' ? asset($user->userData->tax_card_image_f) : asset('uploads/img/logo.png')}})">
                                <input type="file" name="tax_card_image_f" id="tax_card_image_f" class="mediaFile">
                                <label for="tax_card_image_f"><i class="fad fa-pencil"></i></label>
                                <button id="clear-input"><i class="fal fa-times"></i></button>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-12">
                    <div class="image-input wide">
                        ...
                        <div class="imageUpload-wrapper"
                             style="background-image: url({{asset('assets/images/no-image.jpg')}})">
                            <div id="imageUpload" style="background-image: url({{$user->userData->tax_card_image_b !='' ? asset($user->userData->tax_card_image_b) : asset('uploads/img/logo.png')}})">
                                <input type="file" name="tax_card_image_b" id="tax_card_image_b" class="mediaFile">
                                <label for="tax_card_image_b"><i class="fad fa-pencil"></i></label>
                                <button id="clear-input"><i class="fal fa-times"></i></button>
                            </div>
                        </div>
                        @error('tax_card_image_b')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                </div>
            </div>
            <h4 class="inner-title mt-5 mb-4">@lang('site.company_location')</h4>
            <div class="input-group">
                ...
                <a href="" class="open-modal position-relative before-icon" data-toggle="modal"
                   data-target="#LocationMapModal">
                    ...
                    <input type="text" id="location" name="location"
                           ...
                           value="{{$user->userData->location}}" readonly>
                </a>
                @error('location')
                <span class="text-danger">{{$message}}</span>
                @enderror
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group">
                            <input class="" type="text" id="longitude" name="longitude"
                                   placeholder="Longitude" value="{{$user->userData->longitude}}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group">
                            <input class="" type="text" id="latitude" name="latitude"
                                   placeholder="Latitude" value="{{$user->userData->latitude}}">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                    <i class="fad fa-map-marked-alt"></i>
                                </div>
                     ...
                     <li>
                            <div class="form-check">
                                <input class="form-check-input transparent" type="checkbox" id="revision" name="revision"
                                       @if($user->userData->revision==1) checked @endif>
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" id="bank_name" name="bank_name"
                           ...
                           value="@if(!empty($user->bank) && !empty($user->bank->bank_name)) {{$user->bank->bank_name}} @endif">
                </div>
                @error('bank_name')
                <span class="text-danger">{{$message}}</span>
                @enderror
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" id="branch_name" name="branch_name"
                           ...
                           value="@if(!empty($user->bank) && !empty($user->bank->branch_name)) {{$user->bank->branch_name}} @endif">
                </div>
                @error('branch_name')
                <span class="text-danger">{{$message}}</span>
                @enderror
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" id="account_holder_name" name="account_holder_name"
                           placeholder="@lang('site.account_holder_name')"
                           value="@if(!empty($user->bank) && !empty($user->bank->account_number)) {{$user->bank->account_number}} @endif">
                </div>
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" id="soft_code" name="soft_code"
                           ...
                           value="@if(!empty($user->bank) && !empty($user->bank->soft_code)) {{$user->bank->soft_code}} @endif">
                </div>
                @error('soft_code')
                <span class="text-danger">{{$message}}</span>
                @enderror
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" id="iban" name="iban"
                           placeholder="@lang('site.please_enter') @lang('site.iban')"
                           value="@if(!empty($user->bank) && !empty($user->bank->iban)) {{$user->bank->iban}} @endif">
                </div>
                @error('iban')
                <span class="text-danger">{{$message}}</span>
                @enderror
            ...
            <div class="input-group">
                ...
                <div class="position-relative">
                    <input type="number" min="1" max="31" step="1" id="pay_date" name="pay_date"
                           ...
                           value="{{$user->userData->date_of_payment}}">
