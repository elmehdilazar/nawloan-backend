...
@section('title',' | ' . __('site.add') .' '. __('site.factory'))
@section('styles')
    <!-- IntlTelInput -->
...
@section('content')
    <h2 class="section-title mb-5">@lang('site.add') @lang('site.factory')</h2>
    <form action="{{route('admin.factories.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-xl-7 col-lg-9 co-12">
                ...
                <button type="submit" class="btn btn-navy shadow-none min-width-170 mt-4">@lang('site.save') @lang('site.factory')</button>
            </div>
        </div>
    </form>
