        ...
        <div class="chat-sidebar">
            <div class="header">
                ...
                <div class="search-group search-icon">
                    ...
                    <input type="search" name="search" id="search" placeholder="@lang('site.search_chat_placeholder')"
            ...
            <div class="inbox-footer">
                <form action="" class="d-flex">
                    <div class="textarea-group">
                        <textarea name="" id="chat-text" data-url="{{ route('admin.chat.store') }}" rows="4"
                            placeholder="@lang('site.chat_message_holder')"></textarea>
    ...
    <script>
        ...
        $('#chat-text').keypress(function(e) {
            if (e.which == 13) {
                ...
                if ($(this).val() != '') {
                    ...
                    if ($('meta[name=user-type]').attr('content') == "admin" || $('meta[name=user-type]').attr(
                            'content') == 'emp' || $('meta[name=user-type]').attr('content') ==
                        "superadministrator") {
                        $('#chat').append(`
                        <li class="sent-message msg-admins">
                            <div class="message-inner">
        ...
        $('#send_msg').on('click', function(e) {
            ...
            if ($('#chat-text').val() != '') {
                ...
                if ($('meta[name=user-type]').attr('content') == "admin" || $('meta[name=user-type]').attr(
                        'content') == 'emp' || $('meta[name=user-type]').attr('content') == "superadministrator") {
                    $('#chat').append(`
                    <li class="sent-message msg-admins">
                        <div class="message-inner">
                            <div class="flex-align-start">
