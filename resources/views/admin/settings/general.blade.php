            ...
            <div class="col-sm-6 co-12">
                <div class="image-input">
                    ...
                    <div class="imageUpload-wrapper"
                        ...
                        <div id="imageUpload" class="contain dark"
                            style="background-image: url({{ setting('logo') != '' ? asset(setting('logo')) : asset('uploads/img/logo.png') }})">
            ...
            <div class="col-sm-6 co-12">
                <div class="image-input">
                    ...
                    <div class="imageUpload-wrapper"
                        style="background-image: url({{ asset('assets/images/no-image.jpg') }})">
                        <div id="imageUpload" class="contain dark"
                            style="background-image: url({{ setting('favoico') != '' ? asset(setting('favoico')) : asset('uploads/img/logo.png') }})">
        ...
        <div class="row">
            <div class="col-md-6 co-12">
                <div class="input-group">
                    ...
                    <input type="text" name="app_name_ar" id="app_name_ar" placeholder="@lang('site.site_name')"
            ...
            <div class="col-md-6 co-12">
                <div class="input-group">
                    ...
                    <input type="text" name="app_name_en" id="app_name_en" placeholder="@lang('site.site_name')"
            ...
            <div class="col-md-6 co-12">
                <div class="input-group">
                    ...
                    <input type="url" name="site_link" id="site_link" placeholder="@lang('site.site_link')"
            ...
            <div class="col-md-6 co-12">
                <div class="input-group">
                    ...
                    <input type="email" name="email" id="email" placeholder="@lang('site.Primary Email')"
            ...
            <div class="col-md-6 co-12">
                <div class="input-group">
                    ...
                    <input type="text" name="address_en" id="address_en" placeholder="@lang('site.Address In English')"
            ...
            <div class="col-md-6 co-12">
                <div class="input-group">
                    ...
                    <input type="text" name="address_ar" id="address_ar" placeholder="@lang('site.Address In Arabic')"
            ...
            <div class="col-md-6 co-12">
                <div class="input-group">
                    ...
                    <input type="text" name="currency" id="currency" placeholder="@lang('site.currency')"
            ...
            <div class="col-md-6 co-12">
                <div class="input-group">
                    ...
                    <input type="text" name="currency_atr" id="currency_atr" placeholder="@lang('site.currency_atr')"
...
@section('scripts')
   ...
   <!-- <script>
        ...
        if (document.getElementById('customers_terms_conditions_ar'))
            CKEDITOR.replace('customers_terms_conditions_ar', {
                filebrowserUploadMethod: 'form'
            });


        if (document.getElementById('shipping_company_terms_conditions_ar'))
            CKEDITOR.replace('shipping_company_terms_conditions_ar', {
                filebrowserUploadMethod: 'form'
            });
