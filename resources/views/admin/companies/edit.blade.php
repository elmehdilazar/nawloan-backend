...
@section('title',' | ' . __('site.edit') .' '. __('site.the_shipping_company'))
@section('styles')
    <!-- IntlTelInput -->
...
@section('content')
    <h2 class="section-title mb-5">@lang('site.edit') @lang('site.shipping_company')</h2>
    ...
    @endif
    <form action="{{route('admin.companies.update',$user->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
