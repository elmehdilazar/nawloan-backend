...
@section('title',' | ' . __('site.edit_career_category'))
@section('styles')
    <!-- Quill Editor -->
    <link rel="stylesheet" href="{{asset('assets/tiny/css/quill.snow.css')}}">
@endsection
@section('content')
    <h2 class="section-title mb-5">@lang('site.edit_career_category')</h2>
    <form action="{{route('admin.career_categories.update',$category->id)}}" method="post">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-xl-6 col-lg-12 co-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" aria-label="@lang('site.category_title')"
                           ...
                           value="{{$category->category_en}}" name="category_en">
                    @error("category_en")
                ...
                <div class="input-group">
                    ...
                    <div id="" class="editor" style="height: 180px;">
                        <p>{{$category->category_desc_en}}</p>
                    </div>
                    <input type="hidden" name="category_desc_en" id="" value="{{ $category->category_desc_en}}">
                ...
                <div class="input-group">
                    ...
                    <input type="text" aria-label="@lang('site.meta_title')"
                           ...
                           value="{{$category->meta_title_en}}" name="meta_title_en">
                    @error("meta_title_en")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="input-group">
                    ...
                    <input type="text" aria-label="@lang('site.slug')"
                           ...
                           value="{{$category->slug_en}}" name="slug_en">
                    @error("slug_en")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="input-group">
                    ...
                    <div id="" class="editor" style="height: 180px;">
                        <p>{{ $category->meta_desc_en}}</p>
                    </div>
                    <input type="hidden" name="meta_desc_en" id="" value="{{ $category->meta_desc_en}}">
                    @error("meta_desc_en")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
            ...
            <div class="col-xl-6 col-lg-12 co-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" aria-label="@lang('site.category_title')"
                           placeholder="@lang('site.please_enter_category_title')"
                           value="{{$category->category_ar}}" name="category_ar">
                    @error("category_ar")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="input-group">
                    ...
                    <div id="" class="editor" style="height: 180px;">
                        <p>
                            @if($category->category_desc_ar) {{$category->category_desc_ar}} @else @lang('site.write_something') @endif
                        </p>
                    </div>
                    <input type="hidden" name="category_desc_ar" id="" value="{{ $category->category_desc_ar}}">
                ...
                <div class="input-group">
                    ...
                    <input type="text" aria-label="@lang('site.meta_title')"
                           placeholder="@lang('site.please_enter_meta_title')"
                           value="{{$category->meta_title_ar}}" name="meta_title_ar">
                    @error("meta_title_ar")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="input-group">
                    ...
                    <input type="text" aria-label="@lang('site.slug')"
                           placeholder="@lang('site.please_enter_slug')"
                           value="{{$category->slug_ar}}" name="slug_ar">
                    @error("slug_ar")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                <div class="input-group">
                    ...
                    <div id="" class="editor" style="height: 180px;">
                        <p>
                            @if($category->meta_desc_ar){{$category->meta_desc_ar}} @else @lang('site.write_something') @endif
                        </p>
                    </div>
                    <input type="hidden" name="meta_desc_ar" id="" value="{{$category->meta_desc_ar}}">
                    @error("meta_desc_ar")
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
