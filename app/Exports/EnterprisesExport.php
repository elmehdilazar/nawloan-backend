...
class EnterprisesExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize
{
    /**
    ...
    public function collection()
    {
        return User::select('id', 'name', 'phone', 'type', 'active', 'created_at', 'updated_at')->with(['userData', 'bank'])->where('type', 'factory')->get();
    }
}
