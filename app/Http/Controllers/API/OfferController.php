...
class OfferController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $titleKey = 'not_new_offer';
        $bodyKey  = 'not_new_offer_msg';
