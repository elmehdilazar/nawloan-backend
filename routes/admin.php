            ...
            ->middleware(['auth', 'is_admin'])->group(
                ...
                Route::prefix('career_categories')->name('career_categories.')->group(
                    function () {
                        ...
                        Route::post('/destroy-selected', [\App\Http\Controllers\Admin\Career_categoryController::class, 'destroySelected']);
                ...
                Route::get('/factories/{id}/evaluate', [\App\Http\Controllers\Admin\FactoryController::class, 'evaluates'])->name('factories.evaluate');
                Route::get('/factories/{id}/evaluate/changeStatus', [\App\Http\Controllers\Admin\FactoryController::class, 'EvalchangeStatus'])->name('factories.evaluate.changeStatus');
                    // bulk destroy-selected before resource to avoid capture
                    Route::get('/factories/destroy-selected', [\App\Http\Controllers\Admin\FactoryController::class, 'destroySelected'])->name('factories.destroy-selected');
                    ...
                    Route::get('/customers/{id}/evaluate', [\App\Http\Controllers\Admin\CustomerController::class, 'evaluates'])->name('customers.evaluate');
                    Route::get('/customers/{id}/evaluate/changeStatus', [\App\Http\Controllers\Admin\CustomerController::class, 'EvalchangeStatus'])->name('customers.evaluate.changeStatus');
                    // bulk destroy-selected before resource to avoid capture
                ...
                Route::get('/companies/export', [\App\Http\Controllers\Admin\CompanyController::class, 'export'])->name('companies.export');
                    // bulk destroy-selected before resource to avoid capture
                    Route::get('/companies/destroy-selected', [\App\Http\Controllers\Admin\CompanyController::class, 'destroySelected'])->name('companies.destroy-selected');
                ...
                Route::get('/shipment/export', [\App\Http\Controllers\Admin\ShipmentTypeController::class, 'export'])->name('shipment.export');
                    // bulk destroy before resource to avoid capture
                    Route::get('/shipment/destroy-selected', [\App\Http\Controllers\Admin\ShipmentTypeController::class, 'destroySelected'])->name('shipment.destroy-selected.get');
                    Route::post('/shipment/destroy-selected', [\App\Http\Controllers\Admin\ShipmentTypeController::class, 'destroySelected'])->name('shipment.destroy-selected');
